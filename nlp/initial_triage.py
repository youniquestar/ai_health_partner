...
def triage_chat(user_id: str, user_input: str) -> str:
    ...
    if 1 <= step <= len(QUESTIONS):
        ...
        if step < len(QUESTIONS):
            ...
            # The data is already saved in the DB from the previous update_state calls.
            update_state(user_id, 0) # Reset the session

            # Return a friendly string to the user's chat window
            return "Thank you for sharing that with me. I have securely compiled your health report for your doctor to review."
